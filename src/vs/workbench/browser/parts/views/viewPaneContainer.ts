...
/**
 * Views sub menu Instance
 */
export const ViewsSubMenu = new MenuId('Views');

/**
 * Append views sub menu
 */
...
export class ViewPaneContainer extends Component implements IViewPaneContainer {
	...
	/**
	 * On did remove view descriptors
	 */
